...
> **Отказ от ответственности:** Этот проект предназначен тольк
...
Чтобы установить желаемую версию, используйте следующую команду установки. Например, ver v.0.0.1:
...
[New action secret](https://github.com/{{GH_USERNAME}}/3x-ui/settings/secrets/actions)  

| DOCKER_HUB_USERNAME | DOCKER_HUB_TOKEN                                                                                  | GITHUB_TOKEN                                             |
|---------------------|---------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| DOCKER_HUB_USERNAME | <https://app.docker.com/accounts/{{DOCKER_HUB_USERNAME}}/settings/personal-access-tokens/create>  |  <https://github.com/settings/personal-access-tokens/new>
